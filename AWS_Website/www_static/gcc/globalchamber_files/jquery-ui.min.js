...
// IF YOU UPDATE THIS PLUGIN, YOU WILL PROBABLY WANT TO ADD THE FOLLOWING LINE AS IT ENABLES TEXTAREAS AND TEXT INPUTS IN CKEDITOR DIALOGS WITHIN JQUERY UI DIALOGS
jQuery.widget("ui.dialog",jQuery.ui.dialog,{_allowInteraction:function(t){return this._super(t)?!0:jQuery(t.target).closest(".cke_dialog_ui_input_text, .cke_dialog_ui_input_textarea").length?!0:void 0}});